...
function draw() {
    ...
    if (gameState === PLAY) {
        ...
        // Detectar colisiones entre flechas y globos
...
function blueBalloon() {
    ...
    blue.lifetime = 150;
    blue.scale = 0.1;
    blueB.add(blue); // Añadir al grupo blueB
}
...
function greenBalloon() {
    ...
    green.lifetime = 150;
    green.scale = 0.1;
    greenB.add(green); // Añadir al grupo greenB
}
...
function pinkBalloon() {
    ...
    pink.lifetime = 150;
    pink.scale = 1;
    pinkB.add(pink); // Añadir al grupo pinkB
}
